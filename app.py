...
def preprocess_input(form):
    # Log form data
    logger.info("Form data received: %s", dict(form))
...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template("index.html", prediction=None, form_data=form_data, error="Terjadi kesalahan dalam memproses data. Silakan coba lagi.")
